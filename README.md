...
Make sure package org.osgi.service.component.annotations is in your PDE Plug-in project's classpath[*][classpath] and annotate your component implementation classes with @Component and related annotations. The DS Annotations Support plug-in will do the rest.
...
-----
[classpath]: There are several ways to make DS annotations available to your code. E.g.,
