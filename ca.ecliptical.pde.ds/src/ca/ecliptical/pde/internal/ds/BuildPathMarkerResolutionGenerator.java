...
public class BuildPathMarkerResolutionGenerator implements IMarkerResolutionGenerator2 {
	...
	private static final String ANNOTATIONS_LIB_BUNDLE = "ca.ecliptical.pde.ds.lib"; //$NON-NLS-1$

	private static final String ANNOTATIONS_JAR_URL = "platform:/plugin/ca.ecliptical.pde.ds.lib/annotations.jar"; //$NON-NLS-1$
