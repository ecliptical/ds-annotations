...
public class ComponentRefactoringHelper {
	...
	private final HashMap<Object, RefactoringArguments> elements = new HashMap<Object, RefactoringArguments>();
	...
	public RefactoringStatus checkConditions(IProgressMonitor monitor, CheckConditionsContext context) throws OperationCanceledException {
		monitor.beginTask(Messages.ComponentRefactoringHelper_checkConditionsTaskLabel, elements.size());
		try {
			modelFiles = new HashMap<IType, IFile>(elements.size());
			componentNames = new HashMap<IFile, String>(elements.size());
			renames = new HashMap<IFile, IFile>(elements.size());
	...
	public Change createChange(IProgressMonitor monitor) throws CoreException, OperationCanceledException {
		monitor.beginTask(Messages.ComponentRefactoringHelper_createChangeTaskLabel, elements.size());
		try {
